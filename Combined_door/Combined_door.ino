...
int c=0;
long tim;
long Time=3000; //// dorja bondho korar kotokhoner moddhe khulbe na othoba  3 ta stored value khauar somoy
long Tim=3000;  //// asolei dorja lagche naki check korar somoy
  ...
  if (key != NO_KEY){
    ...
    while(i--){
       ...
       for(int i=0;i<pass_input_time;i++){
          ...
          if(sum==len && lock==1){lcd.clear();lcd.print("Key_Pressed..");lcd.setCursor(2,1);lcd.print(key_pass);delay(600);Open_Door();break;}/////////servo start hoiche
