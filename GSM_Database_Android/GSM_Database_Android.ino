...
SoftwareSerial SIM900(7, 8); // configure software serial port // RX, TX
int REDLed= 2;
int GREENLed= 3;
int BLUELed= 4;
int cnt;
...
void SubmitHttpRequest()
{
  ...
  SIM900.println("AT+HTTPPARA=\"URL\",\"justchatamsa.000webhostapp.com/math/index.php\"");// setting the httppara, the second parameter is the website you want to access
//  SIM900.println("AT+HTTPSPARA=\"URL\",\"google.com\"");// setting the httppara, the second parameter is the website you want to access
